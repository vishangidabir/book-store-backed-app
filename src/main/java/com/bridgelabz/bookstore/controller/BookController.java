...
public class BookController {
    ...
    public ResponseEntity<ResposeDTO> getBookById(@PathVariable int id) {
        ResposeDTO responseDTO = new ResposeDTO("GET call Success", bookService.getBookById(id));
        return new ResponseEntity<>(responseDTO, HttpStatus.OK);
    }
    ...
    /**
     * Count book details by quantity to database
     * this is PUT call
     * http://localhost:8080/bookdetails/getbookscount
     */
